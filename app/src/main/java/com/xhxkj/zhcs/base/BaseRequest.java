...
import com.xhxkj.zhcs.util.NetworkThreadPoolExecutor;
...
BaseRequest<T> {
    ...
    public static final String BASE_URL = "http://10.1.71.232:8080/WhatEat/";//svn
//    public static final String BASE_URL = "http://10.1.71.7:8080/WhatEat/";//628
    //public static final String BASE_URL = "http://192.168.1.126:8080/WhatEat/";//334
//    public static final String BASE_URL = "http://139.129.37.224:8080/WhatEat/";//阿里云服务器
    ...
    // 在DEBUG模式下任何操作都会成功
    public static boolean DEBUG = true;//TODO 卧槽一定要记得关(false)啊，不然接口都通了啊！！！
